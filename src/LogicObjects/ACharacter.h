...
class ACharacter : public APhysicObjectBase {
  ...
  friend Effect* Effect::CreateEffect(const EffectData &ed, ACharacter *ch);
...
public:
  ...
  ACharacter(const ACharacterData& data, ALocationBase *loc,  const ObjectInitArgs& args);
  ...
  void DropSlot(InventorySlot sl, const ATransform& tr = ATransform());
